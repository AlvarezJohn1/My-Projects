...
class LoginPage(tk.Frame):
	def __init__(self, root, db):
		...
		bg_photo = tk.PhotoImage(file="CMI.png")
...
class ResultFunctions:
	...
	def recommend_course(self):
		...
		recommendation_label.pack(anchor="center", pady=50)
		...
		# Add buttons below the recommendation label with some space
		tk.Button(self.root, text="Start Exam Again", bg="light blue", command=self.start_exam_again).pack(pady=(20, 10)) 
		tk.Button(self.root, text="Logout", bg="red", command=self.logout).pack(pady=(0, 30)) 
