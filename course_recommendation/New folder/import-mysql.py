...
class LoginPage(tk.Frame):
	...
	def login_form(self):
		...
		img = ImageTk.PhotoImage(Image.open("Cmi.jpg"))
...
class ResultFunctions:
	...
	def recommend_course(self):
		...
		tk.Label(self.root, text=recommendation_text).pack()
		...
		tk.Button(self.root, text="Start Exam Again",bg="light blue",anchor=tk.CENTER , width=20, command=self.start_exam_again).pack() 
		tk.Button(self.root, text="Log out",bg="red",anchor=tk.CENTER , width=15, command=self.logout).pack() 
